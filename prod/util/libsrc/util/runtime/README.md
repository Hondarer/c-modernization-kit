...
公開面は大きく `util/runtime/module_info.h` と `util/runtime/symbol_loader.h` の 2 つに分かれます。
...
- `util/runtime/module_info.h`: モジュール情報取得
- `util/runtime/symbol_loader.h`: 動的シンボル解決
