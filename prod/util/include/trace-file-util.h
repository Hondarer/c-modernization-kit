#ifndef TRACE_FILE_UTIL_H
#define TRACE_FILE_UTIL_H

/**
 *  @file           trace-file-util.h
 *  @brief          ファイルベーストレースプロバイダライブラリ。
 *  @details        トレースメッセージをローテーション付きテキストファイルへ同期書き込みする
 *                  クロスプラットフォームプロバイダです。\n
 *                  trace-etw-util (Windows ETW) および trace-syslog-util (Linux syslog) と
...
#define TRACE_FILE_UTIL_API
    ...
    #define TRACE_FILE_UTIL_API
        ...
        #ifndef TRACE_FILE_UTIL_STATIC
            #ifdef TRACE_FILE_UTIL_EXPORTS
                #define TRACE_FILE_UTIL_EXPORT __declspec(dllexport)
            #else /* !TRACE_FILE_UTIL_EXPORTS */
                #define TRACE_FILE_UTIL_EXPORT __declspec(dllimport)
            #endif /* TRACE_FILE_UTIL_EXPORTS */
        #else      /* TRACE_FILE_UTIL_STATIC */
            #define TRACE_FILE_UTIL_EXPORT
        #endif /* TRACE_FILE_UTIL_STATIC */
    #else      /* __INTELLISENSE__ */
        #define TRACE_FILE_UTIL_EXPORT
    #endif /* __INTELLISENSE__ */
    #ifndef TRACE_FILE_UTIL_API
        #define TRACE_FILE_UTIL_API __stdcall
    #endif /* TRACE_FILE_UTIL_API */
#endif     /* _WIN32 */
...
/**
 *  @def            TRACE_FILE_DEFAULT_MAX_BYTES
...
/**
 *  @def            TRACE_FILE_DEFAULT_GENERATIONS
...
extern "C"
{
     ...
     *  @endcode
     */
    TRACE_FILE_UTIL_EXPORT trace_file_provider_t *TRACE_FILE_UTIL_API
     ...
     *
     *  @param[in]      handle   trace_file_provider_init の戻り値。NULL は無視。
     *  @param[in]      level    トレースレベル (TRACE_FILE_LV_* 定数)。
     *  @param[in]      message  null 終端 UTF-8 文字列。NULL は無視。
     *  @return         成功 0 / 失敗 -1。
     */
    TRACE_FILE_UTIL_EXPORT int TRACE_FILE_UTIL_API
     ...
     *
     *  @param[in]      handle   trace_file_provider_init の戻り値。
     */
    TRACE_FILE_UTIL_EXPORT void TRACE_FILE_UTIL_API
