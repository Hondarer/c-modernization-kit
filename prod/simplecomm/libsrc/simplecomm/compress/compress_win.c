                  ...
                  size_t         src_len)
{
    ...
    ok = Compress(h,
                  src,
                  (SIZE_T)src_len,
                  dst + COMM_COMPRESS_HEADER_SIZE,
                  (SIZE_T)(*dst_len - COMM_COMPRESS_HEADER_SIZE),
                  &cmp_len);
    CloseCompressor(h);
    ...
    *dst_len = COMM_COMPRESS_HEADER_SIZE + (size_t)cmp_len;
    return 0;
}
                    ...
                    size_t         src_len)
{
    ...
    ok = Decompress(h,
                    src + COMM_COMPRESS_HEADER_SIZE,
                    (SIZE_T)(src_len - COMM_COMPRESS_HEADER_SIZE),
                    dst,
                    (SIZE_T)*dst_len,
                    &out_len);
    CloseDecompressor(h);
