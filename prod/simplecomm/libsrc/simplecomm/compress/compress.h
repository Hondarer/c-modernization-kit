...
#define COMM_COMPRESS_HEADER_SIZE 4U

/** 圧縮後の最大バッファサイズ (元データ + ヘッダー + DEFLATE オーバーヘッド)。 */
#define COMM_COMPRESS_BUF_SIZE (COMM_COMPRESS_HEADER_SIZE + 65535U + 64U)
 ...
 *******************************************************************************
 */
extern int comm_compress(uint8_t       *dst,
                         size_t        *dst_len,
                         const uint8_t *src,
                         size_t         src_len);
 ...
 *******************************************************************************
 */
extern int comm_decompress(uint8_t       *dst,
                           size_t        *dst_len,
                           const uint8_t *src,
                           size_t         src_len);
