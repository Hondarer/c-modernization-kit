...
GitHub Actions によるビルド・テスト・ドキュメント生成の自動化と、GitHub Pages を使ったドキュメント公開を学びます。
コードのプッシュをトリガーに品質チェックとデプロイが自動実行される環境を構築します。
...
CI/CD を習得したら、[開発環境・.NET 連携](../07-dev-environment/README.md) に進んでください。
