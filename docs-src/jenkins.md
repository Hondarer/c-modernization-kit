...
本リポジトリの Linux CI では、Oracle Linux 開発コンテナを使用しています。Oracle Linux 8 相当でビルドする場合は、次のイメージを使用します。
...
また、コンテナイメージを GitHub Container Registry から取得する際に認証が必要な場合も、同様に Jenkins Credentials を使用してください。
