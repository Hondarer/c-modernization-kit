...
extern "C"
{
    ...
    {
        string_catalog_argument_kind kind; /**< 有効な共用体メンバーを表す引数種別です。 */
     ...
     */
        ...
        {
            const char *string_value;  /**< @ref STRING_CATALOG_ARGUMENT_KIND_STRING の値です。 */
            char char_value;           /**< @ref STRING_CATALOG_ARGUMENT_KIND_CHAR の値です。 */
            int8_t int8_value;         /**< @ref STRING_CATALOG_ARGUMENT_KIND_INT8 の値です。 */
            uint8_t uint8_value;       /**< @ref STRING_CATALOG_ARGUMENT_KIND_UINT8 と HEX8 の値です。 */
            int16_t int16_value;       /**< @ref STRING_CATALOG_ARGUMENT_KIND_INT16 の値です。 */
            uint16_t uint16_value;     /**< @ref STRING_CATALOG_ARGUMENT_KIND_UINT16 と HEX16 の値です。 */
            int32_t int32_value;       /**< @ref STRING_CATALOG_ARGUMENT_KIND_INT32 の値です。 */
            uint32_t uint32_value;     /**< @ref STRING_CATALOG_ARGUMENT_KIND_UINT32 と HEX32 の値です。 */
            int64_t int64_value;       /**< @ref STRING_CATALOG_ARGUMENT_KIND_INT64 と SSIZE の値です。 */
            uint64_t uint64_value;     /**< @ref STRING_CATALOG_ARGUMENT_KIND_UINT64 と HEX64 の値です。 */
            size_t size_value;         /**< @ref STRING_CATALOG_ARGUMENT_KIND_SIZE の値です。 */
            const void *pointer_value; /**< @ref STRING_CATALOG_ARGUMENT_KIND_POINTER の値です。 */
            double double_value;       /**< @ref STRING_CATALOG_ARGUMENT_KIND_DOUBLE の値です。 */
            int error_code_value;      /**< @ref STRING_CATALOG_ARGUMENT_KIND_ERROR_CODE の値です。 */
        } value;
