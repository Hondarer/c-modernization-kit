# テスト対象のソース ファイル
TEST_SRCS := \
	$(MYAPP_DIR)/prod/libsrc/string_catalog/string_catalog_format.c
...
ADD_SRCS := \
	...
	$(MYAPP_DIR)/prod/libsrc/string_catalog/string_catalog_catalog.c \
	$(MYAPP_DIR)/prod/libsrc/string_catalog/string_catalog_language.c \
