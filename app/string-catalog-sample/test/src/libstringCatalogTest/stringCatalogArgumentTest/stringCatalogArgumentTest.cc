 ...
 */
static int collect_arguments(const string_catalog_entry *entry, format_engine_argument_value *values, ...)
{
    va_list args;
    int ret;
...
class stringCatalogArgumentTest : public Test
{
  protected:
    /** 取り出した値の格納先です。 */
     ...
     */
    void add_kind(const string_catalog_argument_kind kind)
    {
...
TEST_F(stringCatalogArgumentTest, no_argument)
{
    ...
    EXPECT_EQ(STRING_CATALOG_ARGUMENT_KIND_STRING, values[0].kind); // [確認_正常系] - 値の配列が書き換わらないこと。
}
...
TEST_F(stringCatalogArgumentTest, all_argument_kinds)
{
    ...
    add_kind(STRING_CATALOG_ARGUMENT_KIND_STRING);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_INT32);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_UINT32);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_HEX32);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_INT64);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_UINT64);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_HEX64);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_SIZE);
    ...
    EXPECT_EQ(STRING_CATALOG_ARGUMENT_KIND_SIZE,
    ...
    add_kind(STRING_CATALOG_ARGUMENT_KIND_POINTER);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_DOUBLE);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_ERROR_CODE);
    ...
    add_kind(STRING_CATALOG_ARGUMENT_KIND_CHAR);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_INT8);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_UINT8);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_INT16);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_UINT16);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_HEX8);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_HEX16);
    add_kind(STRING_CATALOG_ARGUMENT_KIND_SSIZE);
...
TEST_F(stringCatalogArgumentTest, unknown_argument_kind)
{
    ...
    add_kind(STRING_CATALOG_ARGUMENT_KIND_INT32);
    add_kind((string_catalog_argument_kind)19);
