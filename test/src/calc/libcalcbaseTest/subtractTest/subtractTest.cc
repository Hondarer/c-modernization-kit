...
TEST_F(subtractTest, test_10_subtract_3)
{
    ...
    // Act
    int rtc = subtract(10, 3); // [手順] - subtract(10, 3) を呼び出す。

    // Assert
    EXPECT_EQ(7, rtc); // [確認] - 戻り値が 7 であること。
}
...
TEST_F(subtractTest, test_3_subtract_10)
{
    ...
    // Act
    int rtc = subtract(3, 10); // [手順] - subtract(3, 10) を呼び出す。
...
TEST_F(subtractTest, test_5_subtract_5)
{
    ...
    // Act
    int rtc = subtract(5, 5); // [手順] - subtract(5, 5) を呼び出す。
