...
C/C++ コードでは、OS・CPU・コンパイラ差異の判定を `prod/util/include/util/base/platform.h` と `prod/util/include/util/base/compiler.h` に集約しています。
...
OS 分岐が必要なコードでは、まず `#include <util/base/platform.h>` を追加し、`PLATFORM_*` ベースで分岐します。
...
OS 判定とコンパイラ判定の両方が絡む可能性があるコードでは、原則として `#include <util/base/platform.h>` を使います。
...
- `prod/util/include/util/fs/path_format.h`
- `prod/util/libsrc/util/runtime/module_info.c`
- `test/util/src/libutilTest/statfTest/statfTest.cc`
...
- `prod/porter/src/tech-sample/tcpServer/tcpServer.h`
- `prod/porter/src/tech-sample/tcpServer/tcpServer_linux.c`
- `prod/porter/src/tech-sample/tcpServer/tcpServer_windows.c`
- `prod/util/libsrc/util/trace/backends/etw/trace_etw.c`
...
### export / calling convention の公開マクロ名は維持する

公開 API で使う `*_EXPORT` / `*_API` の名前はライブラリごとに維持します。

利用側互換性を壊さないため、公開マクロ名そのものは変更しません。

実例:

- `CALC_EXPORT` / `CALC_API`
- `POTR_EXPORT` / `POTR_API`
- `PATH_FORMAT_EXPORT` / `PATH_FORMAT_API`

### 定義本体は `dll_exports.h` に寄せる

公開ヘッダーごとに `__declspec(dllexport)` や `__stdcall` を定義せず、`prod/util/include/util/base/dll_exports.h` を使って定義します。
...
- `prod/util/include/util/trace/trace_syslog.h`
- `prod/util/include/util/trace/trace_etw.h`
...
- `prod/util/include/util/fs/path_format.h`
- `test/tutorial/src/param-test/param-test2.cc`
- `test/tutorial/src/param-test/param-test3.cc`
...
- `test/util/src/libutilTest/syslog_providerTest/syslog_providerTest.cc`
- `test/util/src/libutilTest/etw_providerTest/etw_providerTest.cc`
- `test/util/src/libutilTest/etw_sessionTest/etw_sessionTest.cc`
...
- `test/porter/include/porter_test_helper.h`
...
- `prod/util/include/util/base/platform.md`
- `prod/util/include/util/base/compiler.md`
- `docs-src/include-guard-guideline.md`
