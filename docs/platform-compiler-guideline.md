...
C/C++ コードでは、OS・CPU・コンパイラ差異の判定を `prod/com_util/include/com_util/base/platform.h` と `prod/com_util/include/com_util/base/compiler.h` に集約しています。
...
- `prod/com_util/include/com_util/fs/path_format.h`
- `prod/com_util/libsrc/com_util/runtime/module_info.c`
- `test/com_util/src/libcom_utilTest/statfTest/statfTest.cc`
...
- `prod/com_util/libsrc/com_util/trace/backends/etw/trace_etw.c`
...
公開ヘッダーごとに `__declspec(dllexport)` や `__stdcall` を定義せず、`prod/com_util/include/com_util/base/dll_exports.h` を使って定義します。
...
- `prod/com_util/include/com_util/trace/trace_syslog.h`
- `prod/com_util/include/com_util/trace/trace_etw.h`
...
- `test/com_util/src/libcom_utilTest/syslog_providerTest/syslog_providerTest.cc`
- `test/com_util/src/libcom_utilTest/etw_providerTest/etw_providerTest.cc`
- `test/com_util/src/libcom_utilTest/etw_sessionTest/etw_sessionTest.cc`
...
- `prod/com_util/include/com_util/base/platform.md`
- `prod/com_util/include/com_util/base/compiler.md`
