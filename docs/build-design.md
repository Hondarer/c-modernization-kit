...
- モックライブラリ: テスト用のモック実装 (`app/calc/test/libsrc/mock_*/`)
...
- framework/makefw/bin/ 配下のシェルスクリプトがそのまま動作する
...
- `framework/makefw/makefiles/makemain.mk` - テンプレート自動選択
    - `framework/makefw/makefiles/makelibsrc_c_cpp.mk` - C/C++ ライブラリビルド用テンプレート
    - `framework/makefw/makefiles/makesrc_c_cpp.mk` - C/C++ 実行ファイルビルド用テンプレート
    - `framework/makefw/makefiles/makelibsrc_dotnet.mk` - .NET ライブラリビルド用テンプレート
    - `framework/makefw/makefiles/makesrc_dotnet.mk` - .NET 実行ファイルビルド用テンプレート
...
- `app/calc/test/makepart.mk` - テスト共通設定 (テストフレームワークリンク、警告レベル設定)
- `app/calc/test/libsrc/mock_calcbase/makefile` - calcbase モックライブラリ
- `app/calc/test/libsrc/mock_calc/makefile` - calc モックライブラリ
