...
サブモジュール固有の skill と非サブモジュール app 固有の skill は、`make skills` によりルートの `.agents/skills/` へ集約されます。  
...
- サブモジュール由来または非サブモジュール app 由来の skill を追加・削除した後は、`make skills` で集約結果を更新します
